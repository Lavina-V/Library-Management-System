...
class SignUp:
    ...
    def add_header_section(self):
        ...
        self.welcome_label = Label(self.header_frame, text="Sign up for new Student", font = ("Monotype Corsiva",20,"bold","italic"))
    ...
    def setup_homepage(self):
        ...
        self.b_register = Button(self.body_frame, text="Create user", height=2, width=10, command=lambda: self.register_user())
    ...
    def register_user(self):
        ...
        if (name == "" or contact == "" or pwd == ""):
            ...
            query = "Insert into Student(StudentName, StudentPassword,StudentContact) Values (%s,%s,%s)"
            args = (name, pwd, contact)
