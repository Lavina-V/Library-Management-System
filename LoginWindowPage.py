...
class Login:
    ...
    def validate(self):
        ...
        if (self.login_type == "Librarian"):
            query = "Select * from project.librarian where LibrarianName= %s and LibrarianPassword=%s"
        else:
            query = "Select * from project.student where StudentName= %s and StudentPassword=%s"
