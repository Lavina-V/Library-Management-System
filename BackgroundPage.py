...
class BackgroundPage:
    def __init__(self, root):
        ...
        self.m = Message(self.f, width=600, font=("Monotype Corsiva", 20, "bold", "italic"), text="Library",
                         bg="white", relief=SOLID, borderwidth=2)
        self.m.place(x=520, y=20)
        # The footer at the bottom
        self.footer = Label(self.panel, bg="ivory3", height=1,
                            text="@Copyright 2021 Library Management System. All rights reserved")
